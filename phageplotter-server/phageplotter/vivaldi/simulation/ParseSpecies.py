    ...
    with open(setup_file, "r") as species_file:
        ...
        for line in species_file:
            ...
            if currently_analysing=="Bacteria":
                ...
                for a in ant_res:
                    if a not in ["Rif", "Str", "Quin", "NA"]: print("Unrecognized antibiotic resistance", ant_res); exit()
    ...
    for b in bacteria:
        if b["Prophage"]!=None:
            for prop in b["Prophage"]:
                if prop[0] not in phage_names: print("Unrecognized prophage", prop, phage_names); exit()
